...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title><?php echo $page_title; ?> | Dental Compliance Matters</title>
    ...
    <body>
        ...
        <div class="header-container">
            <header class="wrapper clearfix">
                <div class="logo">
                    <a href="/"><img src="img/dental-compliance-matters-logo.jpg" alt="Dental Compliance Matters Logoimg/dental-compliance-matters-logo.jpg" width="175" /></a>
                </div>
                <nav>
                    <ul>
